...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks_cond', choices=['dpt', 'resnet_9blocks_cond_fourierfeat', 'resnet_9blocks_cond', 'resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
        parser.add_argument('--dpt_backbone', type=str, default='vitb_rn50_384', choices=["vitb_rn50_384", "vitl16_384", "vitb16_384"])
        parser.add_argument('--freeze_dpt_backbone', default=False, action='store_true', help='')
        parser.add_argument('--dpt_n_blocks', type=int, default=3, help='# of ResnetBlock_cond after the DPT backbone')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | unaligned_npy | aligned | aligned_npy | single | colorization]')
        # Options for zones: "GRS", "EZ", "NEB", "NTrZ", "SEB", "STrZ", "NTB", "STB", "NPR", "SPR", "GRS_images"
        ...
        parser.add_argument('--fix_time_bug', default=False, action='store_true', help='Fix the bug in the resnet_conv_cond blocks where out=layer(x)')
